	...
	$.extend({
		progressBar: new function() {
			...
			this.defaults = {
				...
				boxImage	: '/swfupload/images/swfupload/progressbar.gif',						// boxImage : image around the progress bar
				barImage	: {
								0:	'/swfupload/images/swfupload/progressbg_red.gif',
								30: '/swfupload/images/swfupload/progressbg_orange.gif',
								70: '/swfupload/images/swfupload/progressbg_green.gif'
